 ...
 const zkLoginUserAddress = jwtToAddress(jwt, userSalt);`}
                        ...
                        {zkLoginUserAddress && (
                            <Alert severity="success">
                                ...
                                test SUI Coin.
                                <br />
                                If theres an error with the service, you can use the{" "}
                                <b>devnet faucet</b>{" "}
                                <a
                            ...
                            <LoadingButton
                                ...
                                onClick={async () => {
                                    try {
                                        ...
                                        txb.moveCall({
                                            target: '0x2::module_name::reward_user', // Address::Module::Function
                                            arguments: [
                                                txb.pure('argument1'), // Replace with your arguments
                                                txb.pure('argument2'),
                                            ],
                                        });
